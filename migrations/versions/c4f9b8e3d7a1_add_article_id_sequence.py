...
def upgrade():
    ...
    if bind.dialect.name == 'oracle':
        ...
        op.execute(sa.text("ALTER TABLE article MODIFY (id DROP DEFAULT)"))
        op.execute(sa.text("ALTER TABLE article MODIFY (id GENERATED BY DEFAULT ON NULL AS IDENTITY)"))
        op.execute(
            sa.text(
